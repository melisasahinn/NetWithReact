...
{
    public class OrderDetailRepository : EFRepositoryBase<OrderDetails>, IOrderDetailsRepository
    {
        public OrderDetailRepository(NetWithReactDbContext dbContext) : base(dbContext)
        {
        }
    }
}
